...
\cvdoubleitem{Infrastructure}{Ansible, Puppet, Jenkins}{OS}{Linux, FreeBSD, OS X, Windows}
\cvdoubleitem{Build}{Gradle, Maven, Autotools, CMake}{Process}{Agile, XP, Scrum, TDD, BDD, Devops}

\section{Experience}

\cventry{2014--Current}{Software Developer (Contract with \href{http://www.energizedwork.com}{Energized Work})}{\href{http://www.sky.uk}{Sky}}{London, UK}{}{}
\begin{itemize}
